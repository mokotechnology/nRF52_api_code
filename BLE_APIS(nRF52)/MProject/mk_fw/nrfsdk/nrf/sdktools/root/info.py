...
"""A command that prints out information about your nRF environment."""
...
from nrfsdk.core.util import platforms


class Info(base.Command):
  """Display information about the current nRF environment.

     This command displays information about the current nRF environment.
  """
...
class BasicInfo(object):
  ...
  def __init__(self):
    ...
    self.version = config.NRF_SDK_VERSION
...
class InstallationInfo(object):
  """Holds information about your nRF SDK installation."""
